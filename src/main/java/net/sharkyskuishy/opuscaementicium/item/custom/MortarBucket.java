...
public class MortarBucket extends Item {
	public MortarBucket(Properties pProperties) {
		super(pProperties);
	}
	...
	public void appendHoverText(ItemStack pStack, TooltipContext pContext, TooltipDisplay pTooltipDisplay, Consumer<Component> pTooltipAdder, TooltipFlag pFlag) {
		if (Screen.hasShiftDown()) {
			pTooltipAdder.accept(Component.translatable("tooltip." + OpusCaementicium.MOD_ID + ".mortar_bucket"));
		} else {
